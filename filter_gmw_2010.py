...
SHP_PATH = "data/mangroves/extracted_2010/gmw_v3_2010_vec.shp"
OUTPUT_DIR = "data/mangroves/gmw_2010_by_island"
...
def filter_island(island_name, bbox):
    ...
    if len(gdf) > 0:
        output_path = os.path.join(OUTPUT_DIR, f"{island_name}_mangroves_2010.gpkg")
