...
function exp_Sampled_2rule0_eval_expression(context) {
    // 
...
function exp_Sampled_2rule1_eval_expression(context) {
...
function exp_Sampled_2rule2_eval_expression(context) {
    // SAMPLE_1 > 1
