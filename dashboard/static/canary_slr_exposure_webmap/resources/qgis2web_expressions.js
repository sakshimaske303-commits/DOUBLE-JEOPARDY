...
function exp_Sampled2_2rule0_eval_expression(context) {
    // 
...
function exp_Sampled2_2rule1_eval_expression(context) {
    // SAMPLE_1 > 0 AND SAMPLE_1 <= 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('SAMPLE_1')  > 0) && (feature.get('SAMPLE_1')  <= 1));
    } else {
        return ((feature.get('SAMPLE_1')  > 0) && (feature.get('SAMPLE_1')  <= 1));
    }
}
...
function exp_Sampled2_2rule2_eval_expression(context) {
    // SAMPLE_1 > 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('SAMPLE_1')  > 1);
    } else {
        return (feature.get('SAMPLE_1')  > 1);
    }
}